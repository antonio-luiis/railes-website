                ...
                <div className="max-w-6xl mx-auto bg-[#F8F9FA] rounded-[40px] p-12 md:p-16 relative overflow-hidden">
                    ...
                    <div className="flex flex-col lg:flex-row items-end gap-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full lg:w-4/5">
                            ...
                            {/* Card 1 */}
                            <div className="bg-white rounded-full py-4 px-8 shadow-sm flex items-center gap-6">
                                <GradientCheck />
                                <div>
...
function GradientCheck() {
    return (
        <div className="w-12 h-12 flex-shrink-0 bg-white rounded-full shadow-sm flex items-center justify-center">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
                    d="M20 6L9 17L4 12"
                    stroke="url(#gradient-check-v1)"
                    strokeWidth="3"
                    strokeLinecap="round"
                    strokeLinejoin="round"
                />
                <defs>
                    <linearGradient id="gradient-check-v1" x1="4" y1="12" x2="20" y2="12" gradientUnits="userSpaceOnUse">
